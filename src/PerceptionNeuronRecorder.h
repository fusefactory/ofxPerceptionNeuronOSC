...
public:
    ...
    void addData(std::map<PerceptionNeuronJointType, PerceptionNeuronJoint> &avatar, ofVec3f offset = ofVec3f(0), float time = 0.f);
    void endRecord();
...
protected:
    ...
    vector<float> timestamps; // relative to the timeline
